<script lang="ts">
	...
	const baseClasses =
		'inline-flex items-center justify-center whitespace-nowrap font-semibold tracking-wider focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 cursor-pointer border-2 disabled:cursor-not-allowed rounded-full hover:scale-110 transition-transform duration-200'
