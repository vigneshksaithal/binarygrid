...
<button
	type="button"
	class="relative aspect-square flex items-center justify-center text-green-600 focus:outline-none disabled:cursor-not-allowed transition-colors hover:bg-black/10 dark:hover:bg-white/10 {fixed
