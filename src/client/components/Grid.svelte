...
<div
	class="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl grid grid-cols-6 gap-1 sm:gap-2 p-2 sm:p-3 border border-border-green bg-secondary-black text-primary-green"
>
